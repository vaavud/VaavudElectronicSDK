 ...
 */
@interface VEFloatConverter : NSObject
 ...
 */
BOOL VEFloatConverterToFloat(VEFloatConverter* converter, AudioBufferList *sourceBuffer, float * const * targetBuffers, UInt32 frames);
 ...
 * @return YES on success; NO on failure
 */
BOOL VEFloatConverterFromFloat(VEFloatConverter* converter, float * const * sourceBuffers, AudioBufferList *targetBuffer, UInt32 frames);
