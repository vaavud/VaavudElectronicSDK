...
@implementation VEFloatConverter
...
BOOL VEFloatConverterToFloat(VEFloatConverter* THIS, AudioBufferList *sourceBuffer, float * const * targetBuffers, UInt32 frames) {
...
BOOL VEFloatConverterToFloatBufferList(VEFloatConverter* converter, AudioBufferList *sourceBuffer,  AudioBufferList *targetBuffer, UInt32 frames) {
    ...
    return VEFloatConverterToFloat(converter, sourceBuffer, targetBuffers, frames);
}

BOOL VEFloatConverterFromFloat(VEFloatConverter* THIS, float * const * sourceBuffers, AudioBufferList *targetBuffer, UInt32 frames) {
    if ( frames == 0 ) return YES;
...
BOOL VEFloatConverterFromFloatBufferList(VEFloatConverter* converter, AudioBufferList *sourceBuffer, AudioBufferList *targetBuffer, UInt32 frames) {
    ...
    return VEFloatConverterFromFloat(converter, sourceBuffers, targetBuffer, frames);
}
